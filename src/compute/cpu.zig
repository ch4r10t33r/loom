...
pub fn mlaAbsorb(li: usize, q_nope: []const f32, out: []f32, n_heads: usize, nope: usize, kvr: usize, stride: usize) bool {
    _ = .{ li, q_nope, out, n_heads, nope, kvr, stride };
    return false;
}

pub fn mlaAttnHeads(li: usize, pos: usize, q_absorbed: []const f32, q_rope: []const f32, out: []f32, n_heads: usize, scale: f32) bool {
    _ = .{ li, pos, q_absorbed, q_rope, out, n_heads, scale };
    return false;
}
