...
pub const registry = [_]Network{
    .{ .name = "devnet", .id = 1337, .arch = "glm4moe", .model = "unsloth/GLM-4.5-Air-GGUF (Q4_K_M)", .desc = "PoC validation -- GLM-4.5-Air 106B-A12B", .strict = false, .bootnodes = &.{"23.88.108.96:8771"} },
